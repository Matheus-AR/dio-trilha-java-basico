...
public class SistemaIbge {
	public static void main(String[] args) {
        ...
        System.out.println("O estado selecionado em letra maiuscula foi: " + ufSelecionado.getNomeMaiusculo());
        System.out.println("O código ibge do estado selecionado foi: " + ufSelecionado.getIbge());
	}
}
